      ...
      return (
        ...
        >
          ...
          {this.props.devices.map((device, key) => (
            <Item
              label={`${device._id} (${device.description})`}
              value={device._id}
              key={device._id}
            />
          ))}
  ...
  _renderDeviceInfo() {
    ...
    return (
      <View>
        ...
        <CardItem>
          <Grid>
            <Col style={styles.labelColumn} size={33}>
              <Row style={styles.gridLabelRow}>
                <Text style={styles.label}>{strings.ID_LABEL}</Text>
              </Row>
              <Row style={styles.gridLabelRow}>
                <Text style={styles.label}>{strings.APP_LABEL}</Text>
              </Row>
              <Row style={styles.gridLabelRow}>
              ...
              <Row style={styles.gridLabelRow}>
                <Text style={styles.label}>{strings.ALTITUDE_LABEL}</Text>
              </Row>
            </Col>
            <Col size={66}>
              ...
              <Row style={styles.gridValueRow}>
                <Text style={styles.value}>{device.appId}</Text>
              </Row>
              <Row style={styles.gridValueRow}>
                <Text style={styles.value}>
                  {toStringWithDecimals(device.latitude, 4)}
                </Text>
              </Row>
              <Row style={styles.gridValueRow}>
                <Text style={styles.value}>
                  {toStringWithDecimals(device.longitude, 4)}
                </Text>
              </Row>
              <Row style={styles.gridValueRow}>
                <Text style={styles.value}>
                  {toStringWithDecimals(device.altitude, 2)} m
                </Text>
              </Row>
            </Col>
          </Grid>
